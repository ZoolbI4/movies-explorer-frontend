const MAIN_BASE_URL = "https://api.movies.zooloo.nomoreparties.co";
...
const MIN_BIG_SCREEN_SIZE = 896;;
const MAX_MEDIUM_SCREEN_SIZE = 1280;
const MIN_MEDIUM_SCREEN_SIZE = 564;
const MAX_SMALL_SCREEN_SIZE = 896;
